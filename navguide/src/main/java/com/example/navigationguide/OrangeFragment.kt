...
class OrangeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val root = inflater.inflate(R.layout.fragment_orange, container, false)
    ...
    private fun addBlueClicked() {
        val action = OrangeFragmentDirections.actionOrangeFragmentToYellowFragment()
        findNavController().navigate(action)
    }

    private fun addRedClicked() {
        val action = OrangeFragmentDirections.actionOrangeFragmentToRedFragment()
        findNavController().navigate(action)
    }
