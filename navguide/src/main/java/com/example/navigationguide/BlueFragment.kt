...
class BlueFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val root = inflater.inflate(R.layout.fragment_blue, container, false)
    ...
    private fun addBlueClicked() {
        val action = BlueFragmentDirections.actionBlueFragmentToVioletFragment()
        findNavController().navigate(action)
    }

    private fun addRedClicked() {
        val action = BlueFragmentDirections.actionBlueFragmentToGreenFragment()
        findNavController().navigate(action)
    }
