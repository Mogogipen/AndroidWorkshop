...
class RedFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val root = inflater.inflate(R.layout.fragment_red, container, false)
    ...
    private fun addBlueClicked() {
        val action = RedFragmentDirections.actionRedFragmentToOrangeFragment()
        findNavController().navigate(action)
    }

    private fun addRedClicked() {
        Toast.makeText(requireContext(), "You cannot add more red", Toast.LENGTH_SHORT).show()
    }
